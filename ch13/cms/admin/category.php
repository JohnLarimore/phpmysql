...
//if there is id, page is editing the category: get the category
if($id){
...
//var_dump($category);
//get and validate test form data
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$errors['description']=(is_text($category['description'], 1, 254)) ? '' : 'Desription should be 1-254 characters'; 
...
<main class="container admin" id="content">
	<form action="category.php?id=<?= $id ?>" method="post" class="narrow">
		...
		<div class="form-check">
			...
			<label class="form-check-label" form="navigation">Navigation</label>
		</div>
