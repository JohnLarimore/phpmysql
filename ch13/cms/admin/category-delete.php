...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	try{
		...
		if($e->errorInfo[1] === 1451){
			redirect('categories.php', ['failure' => 'Category contains articles that must be moved or delted before you can delete it']);
		} else {
			throw $e; 
		}
	}
...
<main class="container admin" id="content">
	...
	<form action="category-delete.php?id=<?= $id ?>" method="POST" class="narrow"
		<p>Click to confirm to delete the category <?= html_escape($category) ?></p>
